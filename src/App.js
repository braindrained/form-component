...
import { tipologies, priceRanges, energy } from  './helpers/var';
        ...
        <header className="App-header">
				...
				<div className="App-body">
					<Form {...{
						...
						beforeButton: <div style={{ clear: 'both', fontSize: 11, lineHeight: '30px', textAlign: 'center' }}>This is a text before button</div>,
						sendButton: {
							text: 'Save',
							style: { margin: '0 auto', float: 'none' }
						},
						afterButton: <div style={{ clear: 'both', fontSize: 11, lineHeight: '30px', textAlign: 'center' }}>This is a text after button</div>,
